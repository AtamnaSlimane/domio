...
const inputVariants = cva(
  `
    flex w-full bg-background dark:bg-input/30 border border-input shadow-xs shadow-black/5 transition-[color,box-shadow] text-foreground placeholder:text-muted-foreground/80 
