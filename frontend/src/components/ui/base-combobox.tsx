...
const inputVariants = cva(
  `
    flex w-full bg-transparent border border-input shadow-xs shadow-black/5 transition-[color,box-shadow] text-foreground placeholder:text-muted-foreground/80 
...
function ComboboxTrigger({
  ...
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn("relative bg-transparent dark:bg-input/30", className)}
      {...props}
    />
  );
}
